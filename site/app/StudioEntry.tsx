 ...
 * the choice into the store (and so into localStorage) means About, Services,
 * Contact and the case studies all stay in Client mode after entering here.
 *
 ...
 *
 * The storage rules from personaStore hold unchanged: client persists in
 * localStorage, and an Ex session in this tab is ended by explicitly walking
 * through the client entrance, which is a selection in its own right.
 */
