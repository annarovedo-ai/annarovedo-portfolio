# Almost Anna — every prompt and every instruction

*Generated from `site/app/lib/almostAnna.ts` and `site/app/homeContent.ts`.*

Almost Anna's replies are generated live by Claude Haiku, so there are no
stored answers. What follows is everything that shapes them: the prompts a
visitor is offered, and the instructions the model is given.
...
### Recruiter — how to answer the opening questions
...
### Client — how to answer the opening questions
...
### Ex Boyfriend — how to answer the opening questions
...
## Shared instructions (all personas)
